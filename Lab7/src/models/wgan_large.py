...
class Generator(nn.Module):
	...
	def __init__(self, args, device):
		...
		self.main = nn.Sequential(
			...
			nn.ConvTranspose2d(self.args.input_dim * 8, self.args.input_dim * 8, 1, 1, 0, bias=False),
			...
			nn.ConvTranspose2d(self.args.input_dim * 4, self.args.input_dim * 4, 1, 1, 0, bias=False),
			...
			nn.ConvTranspose2d(self.args.input_dim * 2, self.args.input_dim * 2, 1, 1, 0, bias=False),
			...
			nn.ConvTranspose2d(self.args.input_dim, self.args.input_dim, 1, 1, 0, bias=False),
...
class Discriminator(nn.Module):
	...
	def __init__(self, args, device):
		...
		self.main = nn.Sequential(
			...
			nn.Conv2d(self.args.input_dim    , self.args.input_dim, 1, 1, 0, bias=False),
			nn.LeakyReLU(0.2, inplace=True),

			## State size: (self.args.input_dim) x 32 x 32
			nn.Conv2d(self.args.input_dim    , self.args.input_dim * 2, 4, 2, 1, bias=False),
			nn.Conv2d(self.args.input_dim * 2, self.args.input_dim * 2, 1, 1, 0, bias=False),
			...
			nn.Conv2d(self.args.input_dim * 4, self.args.input_dim * 4, 1, 1, 0, bias=False),
			...
			nn.Conv2d(self.args.input_dim * 8, self.args.input_dim * 8, 1, 1, 0, bias=False),
